return {
	...
	opts = {
		...
		on_attach = function(bufnr)
			...
			end, "[Q]uickfix all hunks")

			-- Toggles
			map("n", "<leader>htb", gs.toggle_current_line_blame, "[T]oggle [B]lame line")
			map("n", "<leader>htd", gs.preview_hunk_inline, "[T]oggle [D]eleted preview")
